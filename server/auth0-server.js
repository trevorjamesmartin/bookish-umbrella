...
var userInViews = require("../auth0/middleware/userInViews");
var authRouter = require("../auth0/routes/auth");
var indexRouter = require("../auth0/routes/index");
var usersRouter = require("../auth0/routes/users");
dotenv.config();
